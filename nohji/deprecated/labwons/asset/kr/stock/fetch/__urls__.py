...
class urls(object):
    ...
    def _url_(self, code:str, GB:str, menuID:str, stkGb:str):
        return f"http://comp.fnguide.com/SVO2/ASP/SVD_{code}.asp?" \
               f"pGB=1&" \
    ...
    def corp(self) -> str:
        ...
        :return:
        """
        return self._url_("Corp", self.gb, "102", "701")
    ...
    def finance(self) -> str:
        ...
        :return:
        """
        return self._url_("Finance", self.gb, "103", "701")
    ...
    def separateFinance(self) -> str:
        ...
        :return:
        """
        return self._url_("Finance", 'A', "103", "701")
    ...
    def ratio(self) -> str:
        ...
        :return:
        """
        return self._url_("FinanceRatio", self.gb, "104", "701")
    ...
    def invest(self) -> str:
        ...
        :return:
        """
        return self._url_("Invest", "", "105", "701")
