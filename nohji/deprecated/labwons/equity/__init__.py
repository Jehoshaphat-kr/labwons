...
class Equity(object):
    ...
    def __init__(self, ticker: str, **kwargs):
        ...
        if list(meta[["country", "quoteType"]]) == ["KOR", "EQUITY"]:
            ...
            from nohji.deprecated.labwons.equity import snap
            self.data = data = stock(ticker)
            self.snap = snap(ticker, meta, data)
        elif list(meta[["country", "quoteType"]]) == ["KOR", "ETF"]:
            from nohji.deprecated.labwons.equity.fetch.kr.fetch import etf
            from nohji.deprecated.labwons.equity import snap
    ...
    def ohlcv(self):
        ...
        if not hasattr(self, attr):
            from nohji.deprecated.labwons.equity.chart.tech.ohlcv import ohlcv
