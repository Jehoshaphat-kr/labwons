...
from nohji.deprecated.labwons.common.tools import cutString, str2num
from nohji.deprecated.labwons.equity import price
from nohji.deprecated.labwons.equity import urls
from datetime import datetime, timedelta
from pykrx.stock import get_market_cap_by_date, get_etf_portfolio_deposit_file
...
class stock(price):
    ...
    class _two_frames_(DataFrame):
        ...
        ThisYear: DataFrame = DataFrame()
        NextYear: DataFrame = DataFrame()
    ...
    def consensusProfit(self) -> DataFrame:
        ...
        return self._two_frames_(Y=_get_(self.urls.consensusAnnualProfit), Q=_get_(self.urls.consensusQuarterProfit))
